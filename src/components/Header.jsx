...
function Header (){
    return(
        <header className="fixed top-0 z-50 w-full h-20 bg-primary flex flex-row justify-between  max-w-[1200px]" style={{ background: 'radial-gradient(circle at top,  #EED7D8, #FFFFFF)'}}>
