...
const offers = [
    ...
    // },
    {
        ...
        terms : [
           ...
           ' These Offer terms and conditions ("Offer Terms") are in addition to the Audible.in Conditions of Use (available here) and Privacy Policy (available here), to which you agree by using Audible.in and/ or by availing the Offer. In the event of any conflict between the Audible.in Conditions of Use and these Offer Terms, these Offer Terms will prevail in respect of this Offer only.',
            'This Offer will be available from 1st October 2024 to 31st August 2025(both days included) (collectively "Offer Period"). Notwithstanding anything contained herein, Audible shall have the right to revoke the Offer at any time without any prior written notice and without any liability, in this regard.',
    ...
    
    {
        ...
        offerLink: 'https://web.hotstar.com/in/payment/offers?partner=CheggCanara&promo=HS_SUPER3M75&utm_source=Partner&utm_medium=CheggCanara_75Off_Offer',
